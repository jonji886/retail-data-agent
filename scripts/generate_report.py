...
def main() -> None:
    ...
    parser.add_argument("--llm", action="store_true", help="使用 DeepSeek 组织报告文字")
    ...
    if args.llm:
        ...
        report = RetailReportBuilder.to_deepseek_markdown(context, client)
    else:
